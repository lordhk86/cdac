...
class LinkedList{
    ...
    public int middle(){//to find middle element we are using two pointer approch using one loop / one passs 
        if(head==null) return -1;
        else{
            Node p=head;Node s=head;
...
public class HelloWorld {
    public static void main(String[] args) {
        ...
        l.insert(4);l.insert(9); l.insert(9);System.out.println(l.middle());
